...
<title>Microsoft Office Suite Activation and Support</title>
<style>
/* --- General Styles --- */
body {
...
<header>
    <h1>Microsoft Office Suite Activation and Support</h1>
</header>

<nav>
    <a href="#services">Services</a>
    <a href="#office">Microsoft Office</a>
</nav>
...
<section id="services">
    ...
    <div class="services">
        <div class="card">
            ...
            <p>Step-by-step help to activate Windows.</p>
        </div>
        <div class="card">
            <h3>Troubleshooting</h3>
            <p>Fix activation errors and system issues.</p>
        </div>
        <div class="card">
...
<section id="office">
    ...
    <div class="hero">
        ...
        <h3>Boost Your Productivity: Download Microsoft Office, Windows & IDM Now!</h3>
        <div class="price">₱199</div>
        <a class="btn" href="https://www.facebook.com/share/1CX8kZ4VGk/" target="_blank">
            Buy Now via Facebook
        </a>
    </div>
